	...
	?>
      <tr>
        ...
        <td data-label="Hero Title"><?php echo $row['psize']; ?></td>
		 ...
		 <td data-label="First Name"><?php echo $row['tax']; ?> %</td>
        <td data-label="Last Name"><?php echo $row['quantitytype']; ?></td>
        <td data-label="Hero Title"><?php echo $row['base_price']; ?></td>
		
        <td data-label="Last Name"><?php echo $base_price * $row['quantity']; ?></td>
...
<table style="width:100%;border: none;">
		...
		<table style="width:40%;border:none;">
		 ...
		 <table style="width:33%;margin-left:620px;margin-top:-130px;border:none;">
		  ...
		  <tr>
			<td style="border:none;"><b>Total :</b> <?php echo array_sum($base); ?> </td>
		  </tr>
		  <?php if($row['Billtaxtype'] == 'GST'){ ?>
		  <tr>
			<td style="border:none;"><b>CGST | SGST :</b> <?php echo $row['gst']; ?></td>
		  </tr>
		  <?php }else if($row['Billtaxtype'] == 'IGST'){ ?>
		  <tr>
			<td style="border:none;"><b>IGST Tax :</b> <?php echo $row['gst']; ?></td>
		  </tr>
		  <?php } ?>
...
<hr>
	     ...
	     <P style="margin-left:15px;"><b>Amount in Word :</b> <?php echo $num = convert_number_to_words($row['payable_amount']);?> </P>
