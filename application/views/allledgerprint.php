...
<div class="container">
   <h3 style="text-align:center;text-decoration:">All Ledger Records</h3>
...
<table>
	...
	?>
      ...
      <tr>
		...
		<td><?php echo $row1['previousLimt']; ?></td>
  ...
  <?php }else{ ?>
  <hr>
<P style="margin-left:15px;margin-right:15px;"><b>No Record founded</b> </p>
  <?php } ?>
